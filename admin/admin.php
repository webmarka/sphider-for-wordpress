...
<?php 
	function sphider_list_cats($parent, $lev, $color, $message) {
		...
		if (mysql_num_rows($result) <> '')
			while ($row = mysql_fetch_array($result)) {
				...
				$color = sphider_list_cats($id, $lev + 1, $color, "");
			}
...
<?php 
	...
	switch ($f)	{
		...
		case 7:
			...
			sphider_list_cats (0, 0, "white", $message);
		break;
		case categories:
			sphider_list_cats (0, 0, "white", "");
		break;
		case edit_cat;
			editcatform($cat_id);
		break;
